...
public class LoginComServlet extends HttpServlet {
    ...
    private final String LOGIN_PAGE = "/views/LoginCom.jsp";
    private final String HOME_PAGE = "/views/HomePage.jsp";
    private final String ADMIN_PAGE = "/views/AdminPage.jsp";
